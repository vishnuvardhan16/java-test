...
* The first thing you need is to have a github or gitlab account. If you don't have it yet, you can create it on [github website][2] or [gitlab website][3].
...
1. Fork this repo using the github/gitlab website.
